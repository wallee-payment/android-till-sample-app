...
public class SubmissionResultActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.submission_result_activity);

        SubmissionResult result = Utils.getSubmissionResult(getIntent().getExtras());
    ...
    private String resultToString(SubmissionResult result) {
