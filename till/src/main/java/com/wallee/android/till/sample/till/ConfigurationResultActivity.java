...
public class ConfigurationResultActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.configuration_result_activity);

        ConfigurationResult result = Utils.getConfigurationResult(getIntent().getExtras());
    ...
    private String resultToString(ConfigurationResult result) {
