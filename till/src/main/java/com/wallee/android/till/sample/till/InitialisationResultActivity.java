...
public class InitialisationResultActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.initialisation_result_activity);

        InitialisationResult result = Utils.getInitialisationResult(getIntent().getExtras());
    ...
    private String resultToString(InitialisationResult result) {
